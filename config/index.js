export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1c04d61ca368c4e9",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "df5b439457cd1f02e94c02d7a5f631df",
   ...
   */
  USERS: ["oX30X6N4A0-51ullTSg5r0wQyIZ4","oX30X6DpVxicHPpwx2wEG4OoXEyY"]
    {
      // 想要发送的人的名字
      name: "老婆0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "GnWIRSoN0McGTuYalMvQjR7BPWWQU1946po7s0BnmCE",
      // 所在省份
      province: "福建",
      // 所在城市
      city: "厦门",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1996", "date": "11-15"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-07"},
